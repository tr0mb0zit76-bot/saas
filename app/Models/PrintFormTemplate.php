...
class PrintFormTemplate extends Model
{
    ...
    /**
     * Дополнительные смещения подписи/печати из CRM (margin-left/top в VML после вставки картинок).
     * Если false — смещения из CRM не применяются (остаётся 0), но постобработка колонтитула
     * (позиционирование «не в ячейке», плотная строка) и очистка «осиротевших» запятых всё равно выполняются.
     */
